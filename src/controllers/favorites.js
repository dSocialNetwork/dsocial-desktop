export default ($scope, $rootScope, $location, $uibModalInstance, autoCancelTimeout, dSocialService, dpayService, activeUsername) => {
  $scope.term = '';
  ...
  $scope.removeClicked = (b) => {
    ...
    dSocialService.removeFavorite(activeUsername(), b._id).then((r) => {
