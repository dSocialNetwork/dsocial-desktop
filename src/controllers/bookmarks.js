export default ($scope, $rootScope, $location, $uibModalInstance, $timeout, dSocialService, dpayService, activeUsername) => {
  ...
  $scope.removeClicked = (b) => {
    $scope.processing = true;
    dSocialService.removeBookmark(b._id, activeUsername()).then((r) => {
