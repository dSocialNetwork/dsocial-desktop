...
export default ($scope, $rootScope, $timeout, $uibModalInstance, settingsService, dSocialService, dpayApi, constants) => {
  ...
  $scope.$watch('currency', (newVal, oldVal) => {
    ...
    dSocialService.getCurrencyRate(newVal).then((resp) => {
