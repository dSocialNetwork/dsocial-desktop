export default ($scope, $rootScope, $filter, $routeParams, $timeout, $location, userService, dpayService, dSocialService, dpayAuthenticatedService) => {
  ...
  $scope.search = () => {
    ...
    dSocialService.searchEscrow(id).then((resp) => {
