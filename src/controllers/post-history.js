...
export default ($scope, $rootScope, $uibModalInstance, $filter, $sce, $timeout, dSocialService, content) => {
  ...
  $scope.loading = true;
  dSocialService.commentHistory(content.author, content.permlink).then((resp) => {
