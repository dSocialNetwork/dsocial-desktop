...
export default ($scope, $rootScope, $routeParams, $filter, $timeout, $uibModal, $location, $q, dpayService, dSocialService, helperService, activeUsername, activePostFilter, constants) => {
  ...
  $scope.addBookmark = () => {
    ...
    dSocialService.addBookmark(activeUsername(), $scope.post).then((resp) => {
      $scope.bookmarked = true;
