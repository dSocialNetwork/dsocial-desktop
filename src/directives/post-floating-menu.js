const strShareSuffix = 'shared via dSocial';
...
export default () => {
  return {
    ...
    controller: ($scope, $rootScope, $timeout, $filter, $uibModal, $confirm, dpayAuthenticatedService, dpayService, dSocialService, helperService, activeUsername) => {
      ...
      dSocialService.commentHistory($scope.content.author, $scope.content.permlink, true).then((resp) => {
